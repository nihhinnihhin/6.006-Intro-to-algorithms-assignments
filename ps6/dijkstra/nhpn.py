...
class Node:
    ...
    def __init__(self, longitude, latitude, state, description,featureid):
        ...
        # (node1,node2) is unhashable, then replace it with (node1.featureid,node2.featureid)
    ...
    def __init__(self, nodesource='data/nhpn.nod', linksource='data/nhpn.lnk'):
        ...
        try:
            ...
            for line in nodefile:
                ...
                node = Node(longitude, latitude, state, description,featureId)
