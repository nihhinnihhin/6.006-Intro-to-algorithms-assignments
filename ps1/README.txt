...
surrounding document may cause you to lose points.  

In addition, your solutions 
...
Proof
    ...
    Your answer should take the form of a series of lines.  These lines will be formatted using LaTeX, but you don't need to learn all of LaTeX to
 write up your proof --- all you need to learn is the basics of the math mode.  See the website for resources on this topic.  The source of the
...
Counterexamples
 ...
 with a very simple matrix.  The extra LaTeX code in there, \begin{verbatim}
    and \end{verbatim}, is used to make the formatting of your solution look nice, but is not necessary.
